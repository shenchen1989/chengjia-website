...
export const PORTFOLIO_ITEMS: PortfolioItem[] = [
  {
    ...
    description: "Located in the heart of Rome's Vatican area, this boutique guesthouse blends fashion, art, and premium living. Each room is curated with a unique soul: from the bold colors of Andy Warhol to the timeless elegance of GUCCI, Hermès, and Chanel. The public areas emphasize comfort and Italian sophistication.",
    description_it: "Situato nel cuore della zona vaticana di Roma, questa guesthouse boutique fonde moda, arte e vita premium. Ogni camera ha un'anima unica: dai colori di Andy Warhol all'eleganza di GUCCI, Hermès e Chanel. Le aree comuni enfatizzano il comfort e la raffinatezza italiana.",
    description_da: "Beliggende i hjertet af Roms Vatikan-område kombinerer dette boutique guesthouse mode, kunst og luksus. Hvert værelse har sin egen unikke sjæl: fra Andy Warhols dristige farver til den tidløse elegance fra GUCCI, Hermès og Chanel.",
    location: "Rome, Italy",
    year: "2023",
  ...
  },
  {
    ...
    description: "Inspired by the starry sky and modern art, this renovation features a ceremonial entrance, dynamic constellation dining zones, and atmospheric art salons. Light and shadow play a key role in creating a sensory dining experience in Vienna.",
    description_it: "Ispirato al cielo stellato e all'arte moderna, questo progetto presenta un ingresso cerimoniale, zone zodiacali e saloni d'arte. Luci e ombre creano un'esperienza gastronomica sensoriale a Vienna.",
    description_da: "Inspireret af stjernehimlen og moderne kunst byder denne renovering på en ceremoniel indgang, dynamiske stjernetegns-spisezoner og stemningsfulde kunstsaloner i hjertet af Wien.",
  ...
  },
  {
    ...
    description: "A comprehensive large-scale dining design in Turin. Projects include facade renovation, main floor bar, and basement dining. Contrast between warm and cool materials creates a high-end yet welcoming atmosphere.",
    description_it: "Un progetto di ristorazione su larga scala a Torino. Include la ristrutturazione della facciata, il bar al piano terra e la zona pranzo nel seminterrato. Il contrasto materico crea un ambiente raffinato e accogliente.",
    description_da: "Et omfattende restaurantdesign i Torino. Projektet omfatter facade-renovering, barområde og spisesal i underetagen. Kontrasten mellem varme og kølige materialer skaber en eksklusiv atmosfære.",
  ...
  },
  {
    ...
    description: "This commercial renovation in Piedmont focuses on revitalizing community atmosphere through redesigned bar and lounge areas. Modern social functions are injected into the historical fabric of the building.",
    description_it: "Questa ristrutturazione commerciale in Piemonte rivitalizza l'atmosfera comunitaria attraverso la riprogettazione del bar e dei lounge, integrando funzioni sociali moderne nel tessuto storico.",
    description_da: "Denne erhvervsrenovering i Piemonte fokuserer på at revitalisere det lokale fællesskab gennem nydesignede bar- og loungeområder, der forener historisk arkitektur med moderne funktioner.",
  ...
  },
  {
    ...
    description: "Centered on the 'Forest Build' concept, this Austrian restaurant uses extensive bamboo and natural textures to create a forest-like dining experience. It features Zen-inspired entrances, a visual bamboo labyrinth, and moonlight grove dining.",
    description_it: "Basato sul concetto di 'Forest Build', questo ristorante in Austria utilizza bambù e materiali naturali per creare un'esperienza immersiva nella foresta. Include un ingresso Zen e un labirinto visivo di bambù.",
    description_da: "Med 'Forest Build' som kernekoncept bruger denne østrigske restaurant bambus og naturlige materialer til at skabe en skovlignende spiseoplevelse. Projektet omfatter en zen-inspireret indgang og en bambuslabyrint.",
    location: "Austria",
    year: "2024",
  ...
  },
  {
    ...
    description: "Located in Venice, this modern sushi restaurant combines Venetian textures with Japanese minimalism. Semi-transparent partitions and dark wood surfaces create an elegant fusion of Italian architecture and Oriental grace.",
    description_it: "Situato a Venezia, questo moderno ristorante di sushi combina trame veneziane con il minimalismo giapponese. Divisori semitrasparenti e legno scuro creano una fusione tra architettura italiana e grazia orientale.",
    description_da: "Denne moderne sushi-restaurant i Venedig kombinerer venetiansk tekstur med japansk minimalisme. Halvgennemsigtige skillevægge og mørke træflader skaber en fusion af italiensk arkitektur og orientalsk elegance.",
  ...
  },
  {
    ...
    category: "Commercial",
    description_zh: "位于意大利的 Sushi Ten 餐厅户外区域改造项目。通过极简的设计手法和精选的户外材质，打造出宁静而富有和式美学的用餐环境。设计强调了光影在木质格栅间的流动，以及东方禅意元素与现代建筑结构的和谐共生。",
    description: "An outdoor renovation in Italy for Sushi Ten, focusing on minimalist Japanese aesthetics. The design emphasizes light play through wooden louvers and the harmony between Zen elements and modern structure.",
    description_it: "Una ristrutturazione esterna in Italia per Sushi Ten, focalizzata sull'estetica giapponese minimalista. Il design enfatizza il gioco di luci attraverso le doghe in legno e l'armonia tra elementi Zen e struttura moderna.",
    description_da: "En udendørs renovering af Sushi Ten i Italien med fokus på minimalistisk japansk æstetik. Designet fremhæver lysets spil gennem trælister og harmonien mellem zen-elementer og moderne arkitektur.",
    location: "Italy",
    year: "2023",
  ...
  },
  {
    ...
    description: "A steakhouse design in Udine blending industrial style with modern luxury. Exposed structures, leather seating, and warm wood tones create a bold yet elegant environment. Emphasis on lighting and efficient spatial layout.",
    description_it: "Un design di steakhouse a Udine che fonde stile industriale e lusso moderno. Strutture a vista, sedute in pelle e caldi toni del legno creano un ambiente audace ma elegante. Grande enfasi su illuminazione e layout spaziale.",
    description_da: "Et steakhouse-design i Udine, der forener industriel stil med moderne luksus. Blottede strukturer, lædersæder og varme trætoner skaber et råt, men elegant miljø med fokus på lys og rumudnyttelse.",
  ...
  },
  {
    ...
    description: "A luxury private villa in Vienna balancing modern minimalism with classic elegance. Features include high-ceiling living rooms, a sculptural spiral staircase, and dedicated private studies. Every detail is crafted for high-end comfort.",
    description_it: "Una villa privata di lusso a Vienna che bilancia il minimalismo moderno con l'eleganza classica. Caratterizzata da soffitti alti, una scala a chiocciola scultorea e studi privati. Ogni dettaglio è progettato per il massimo comfort.",
    description_da: "En luksuriøs privat villa i Wien, der balancerer moderne minimalisme med klassisk elegance. Projektet omfatter højloftede stuer, en skulpturel vindeltrappe og dedikerede kontorer.",
    location: "Vienna, Austria",
    year: "2024",
  ...
  },
  {
    ...
    description: "A high-end apartment design in Rome's Numidio Quadraro area. Delicate material usage and light processing create a modern private sanctuary.",
    description_it: "Un design di appartamento di fascia alta nella zona Numidio Quadraro di Roma. L'uso delicato dei materiali e la lavorazione della luce creano un santuario privato moderno.",
    description_da: "Et eksklusivt lejlighedsdesign i Roms Numidio Quadraro-område. Fin brug af materialer og lysbehandling skaber et moderne privat fristed.",
    location: "Rome, Italy",
    year: "2024",
  ...
  },
  {
    ...
    description: "A luxury villa in Tuscany merging traditional charm with modern standards. Hand-carved stone, timber beams, and micro-cement create a breathable space. Expansive windows invite the rolling hills into the interior, blurring the lines between home and nature.",
    description_it: "Una villa di lusso in Toscana che fonde il fascino tradizionale con standard moderni. Pietra lavorata a mano, travi in legno e micro-cemento creano uno spazio traspirante. Ampie finestre invitano le colline all'interno.",
    description_da: "En luksusvilla i Toscana, der forener traditionel charme med moderne standarder. Håndhugget sten, bjælker og mikrocement skaber et rum, der kan ånde. Store vinduer inviterer de bølgende bakker indenfor.",
  ...
  },
  {
    ...
    category: "Residential",
    description_zh: "位于罗马 Nettuno 的大型复式公寓全案设计。空间横跨地下一层（B1）、地面层（1F）及二层（2F）。地下一层专注于私密的休憩空间，地面层作为核心社交区域，二层则设计为充满趣味的儿童房。整体设计风格现代简约，通过利落的线条与精致的材质对比，打造出极具品质感的都市生活空间。",
    description: "A multi-level duplex in Nettuno, Rome, spanning three floors. B1 offers private rest areas, the Ground Floor serves as the social hub with a modern fireplace, and the 2nd Floor hosts creative children's rooms. Sharp lines and refined material contrasts define this urban living space.",
    description_it: "Un duplex su più livelli a Nettuno, Roma, distribuito su tre piani. Il B1 offre aree di riposo private, il piano terra funge da fulcro sociale con un camino moderno e il 2° piano ospita camere per bambini. Linee decise definiscono questo spazio urbano.",
    description_da: "En lejlighed over flere etager i Nettuno, Rom. Underetagen rummer private områder, stueetagen er det sociale samlingspunkt med moderne pejs, og anden sal er indrettet med kreative børneværelser. Skarpe linjer kendetegner boligen.",
    location: "Rome, Italy",
    year: "2024",
  ...
  },
  {
    ...
    description: "A minimalist apartment renovation in Rome focusing on the concept of 'void' and 'utility'. A continuous functional facade integrates storage, display, and TV units, removing visual clutter. Soft lighting creates a pure, silent sanctuary.",
    description_it: "Ristrutturazione minimalista a Roma focalizzata sul concetto di 'vuoto' e 'utilità'. Una facciata funzionale continua integra contenimento e display, eliminando il disordine visivo. Luci soffuse creano un santuario puro.",
    description_da: "En minimalistisk lejlighedsrenovering i Rom med fokus på 'tomhed' og 'brugbarhed'. En gennemgående funktionel facade integrerer opbevaring og display, hvilket fjerner rod og skaber en rolig atmosfære.",
    location: "Rome, Italy",
    year: "2024",
  ...
  },
  {
    ...
    description: "A boutique hotel in Livorno designed with narrative spatial nodes. Highlights include a striking welcome lobby, a vibrant retro bar, and a professional music lounge. Guest rooms focus on privacy and artistic unity.",
    description_it: "Un boutique hotel a Livorno progettato con nodi spaziali narrativi. I punti salienti includono una hall suggestiva, un vivace bar retrò e una lounge musicale professionale. Le camere puntano su privacy e arte.",
    description_da: "Et boutique-hotel i Livorno designet med narrative rumlige knudepunkter. Højdepunkter inkluderer en markant lobby, en livlig retro-bar og en professionel musiklounge.",
  ...
  },
  {
    ...
    description: "A Korean BBQ restaurant in Montecatini merging Oriental aesthetics with Tuscan architectural context. Dark wood grilles, geometric lines, and curated lighting create a sophisticated boutique dining space.",
    description_it: "Un ristorante barbecue coreano a Montecatini che fonde l'estetica orientale con il contesto architettonico toscano. Griglie in legno scuro e linee geometriche creano uno spazio raffinato.",
    description_da: "En koreansk BBQ-restaurant i Montecatini, der forener orientalsk æstetik med toscansk arkitektur. Mørke trælister, geometriske linjer og kurateret lys skaber et sofistikeret spisemiljø.",
    location: "Tuscany, Italy",
    year: "2023",
  ...
  },
  {
    ...
    description: "A boutique nail salon in Italy featuring pure white and soft pink tones. Fluid curved elements define the circulation, while minimalist furnishings and refined lighting create a healing sensory journey for customers.",
    description_it: "Un salone di bellezza in Italia caratterizzato da toni bianco puro e rosa tenue. Elementi curvi fluidi definiscono la circolazione, mentre arredi minimalisti creano un viaggio sensoriale curativo.",
    description_da: "En boutique neglesalon i Italien med rene hvide og bløde lyserøde toner. Flydende buede elementer definerer rummet, mens minimalistisk interiør og raffineret lys skaber en healende oplevelse.",
    location: "Italy",
    year: "2024",
  ...
  },
  {
    ...
    description: "Sushi Nami restaurant design utilizes light and materiality to create a deep, modern dining space. The project integrates detailed facade nodes and precise floor plans for aesthetic and commercial harmony.",
    description_it: "Il design del ristorante Sushi Nami utilizza luce e materiali per creare uno spazio profondo e moderno. Il progetto integra nodi di facciata dettagliati e planimetrie precise.",
    description_da: "Sushi Nami restaurantdesign bruger lys og materialer til at skabe et dybt, moderne rum. Projektet integrerer detaljerede facadenoder og præcise plantegninger for æstetisk harmoni.",
    location: "Europe",
    year: "2024",
    imageUrl: "https://i.postimg.cc/tJpdcght/场景_10.jpg",
    gallery: [
      "https://i.postimg.cc/tJpdcght/场景_10.jpg", "https://i.postimg.cc/264FTWBL/ELE.jpg", "https://i.postimg.cc/0jPG4Npy/PLAN.jpg", "https://i.postimg.cc/GtdPfpkt/场景_1.jpg", 
